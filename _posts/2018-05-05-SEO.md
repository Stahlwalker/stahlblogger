...
8. Sitemap Test:
       ...
       A sitemap is important because it tells informs search engines how many pages a site has and it improves the sites ability to be crawled. Sharing your sitemap xml file with Google Search Console [Google Search Console](https://www.google.com/webmasters/tools/home?hl=en) is a must for SEO. 
...
15. Favicon Test:
        ...
        A favicon image is the main sites image. It is displayed on the tabs in your browser and when it's shared across social media channels. You will also notice that the favicon displays when the URL is shared through text messaging. Here is a link to a favicon generator that I prefer [Google Search Console](https://www.visiospark.com/apple-touch-icon-favicon-generator/)       
...
* [Google Search Console](https://www.visiospark.com/apple-touch-icon-favicon-generator/)  
